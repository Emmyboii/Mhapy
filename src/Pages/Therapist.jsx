...
const Therapist = () => {
    ...
    useEffect(() => {
        localStorage.setItem('therapistFrame', therapist);
    }, [therapist]);
        ...
        <div className="font-medium flex flex-col">
            ...
            <div className="flex items-center sm:gap-10 gap-3 mb-6 bg-[#F6F6F6] text-[#25252580] p-[9px] rounded-[10px] sm:w-[370px] w-full justify-between">
                <p
                    ...
                    onClick={() => {
                        localStorage.setItem('therapistFrame', 'Team Member')
                        setTherapist('Team Member')
                    }}
                >
                    Team Member
                </p>
                <p
                    className={`cursor-pointer text-[13px] sm:text-[15px] py-2 px-5 ${therapist === 'Find Team Member' ? 'bg-white rounded-lg' : ''}`}
                    onClick={() => {
                        localStorage.setItem('therapistFrame', 'Find Team Member')
                        setTherapist('Find Team Member')
                    }}
                >
                    Find Team Member
                </p>
                ...
                <div className='border border-[#00000033] pt-9 pb-[50px] flex flex-col gap-8 px-[23px] rounded-[10px]'>
                    <div className='flex md:flex-row w-full gap-4 md:gap-0 flex-col items-center justify-between'>
                        <div className='flex justify-between items-center w-full'>
                            <p className='text-[#252525] text-[20px] font-medium'>All teams members</p>
                        </div>
                    ...
                    <div className='flex w-full items-center justify-between gap-10 sd:gap-0 p-[9px]'>
                        ...
                        <button className='bg-[#441890] text-white py-[7px] px-[10px] rounded-[4.5px] w-[54%] text-[12px]'>Add member</button>
